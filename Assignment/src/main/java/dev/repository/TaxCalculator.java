...
public class TaxCalculator 
{
    ...
    public double calculateTax() 
    {
        ...
        if (category.equalsIgnoreCase("Male")) 
        {
            ...
            {
                taxAmount = (totalIncome - 300000) * 0.05;
            } 
            else if (totalIncome <= 700000) 
            {
                taxAmount = (400000 - 300000) * 0.05 + (totalIncome - 400000) * 0.1;
            } 
            else if (totalIncome <= 1100000) 
            {
                taxAmount = (700000 - 400000) * 0.1 + (totalIncome - 700000) * 0.15;
            } 
            else if (totalIncome <= 1650000) 
            {
                taxAmount = (1100000 - 700000) * 0.15 + (totalIncome - 1100000) * 0.2;
            } 
            else 
            {
                taxAmount = (1600000 - 1100000) * 0.2 + (totalIncome - 1600000) * 0.25;
            }
        } 
